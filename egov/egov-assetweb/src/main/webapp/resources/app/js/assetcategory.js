...
$(document).ready(function(){
	...
	//********************
	var assetaccountcodeglcode=$('#assetaccountcodeglcode').val();
	var assetaccountcodename=$('#assetaccountcodename').val();
	var assetaccountcode=assetaccountcodeglcode+'~'+assetaccountcodename;
	if (assetaccountcodeglcode) {
		$('#assetaccountcode').val(assetaccountcode);
	}
	var revalutionreserveaccountcodeglcode=$('#revalutionreserveaccountcodeglcode').val();
	var revalutionreserveaccountcodename=$('#revalutionreserveaccountcodename').val();
	var revalutionreserveaccountcode=revalutionreserveaccountcodeglcode+'~'+revalutionreserveaccountcodename;
	if (revalutionreserveaccountcodeglcode) {
		$('#revalutionreserveaccountcode').val(revalutionreserveaccountcode);
	}
	var accumulateddepriciationcodeglcode=$('#accumulateddepriciationcodeglcode').val();
	var accumulateddepriciationcodename=$('#accumulateddepriciationcodename').val();
	var accumulateddepriciationcode=accumulateddepriciationcodeglcode+'~'+accumulateddepriciationcodename;
	if (accumulateddepriciationcodeglcode) {
		$('#accumulateddepriciationcode').val(accumulateddepriciationcode);
	}
	var depriciationexpenseaccountglcode=$('#depriciationexpenseaccountglcode').val();
	var depriciationexpenseaccountname=$('#depriciationexpenseaccountname').val();
	var depriciationexpenseaccount=depriciationexpenseaccountglcode+'~'+depriciationexpenseaccountname;
	if (depriciationexpenseaccountglcode) {
		$('#depriciationexpenseaccount').val(depriciationexpenseaccount);
	}
	//********************
	...
	depriciationexpenseaccount_initialize();
	accumulateddepriciationcode_initialize();
	assetaccountcode_initialize();
	revalutionreserveaccountcode_initialize()
	$('#fund').val($('#fund').val());
	loadCheckListTable();
	if($("#mode").val() == 'edit'){
	   ...
	   if(data.issubledger && originaldetailtypeid!='' && originaldetailkeyid=='')
	    {
		   bootbox.alert($.i18n.prop('msg.please.enter',subLedgerDisplayName),function() {
			...
			$('.creditdetailname').val(data.name);
			$('.creditdetailid').val(data.id); 
			$('.creditaccountcode').val(data.glcode);
		}
  });
}

function revalutionreserveaccountcode_initialize() {
	 var custom = new Bloodhound({
	    datumTokenizer: function(d) { return d.tokens; },
	    queryTokenizer: Bloodhound.tokenizers.whitespace,
		   remote: {
	            ...
	            filter: function (data) {
	                ...
	                return $.map(responseObj, function (ct) {
	                    return {
	                        ...
	                        glcode: ct.glcode,
	                        issubledger: ct.isSubLedger,
	                        revalutionreserveaccountcodesearch: ct.glcode+' ~ '+ct.name
	                    };
	                });
	            }
	        }
  ...
  var dt=$('.revalutionreserveaccountcode').typeahead({
  	hint : true,
		highlight : true,
		minLength : 1
		
	}, {		    
        displayKey: 'revalutionreserveaccountcodesearch',
        source: custom.ttAdapter()
  }).on('typeahead:selected typeahead:autocompleted', function (event, data) {
	   ...
	   if(data.issubledger && originaldetailtypeid!='' && originaldetailkeyid=='')
	    {
		   bootbox.alert($.i18n.prop('msg.please.enter',subLedgerDisplayName),function() {
			...
			$(this).parents("tr:first").find('.creditDetailTypeName').val(detailTypeName);
			$(this).parents("tr:first").find('.creditDetailKeyName').val(detailKeyName);
			$('.revalutionreserveaccountcodename').val(data.name);
			$('.revalutionreserveaccountcodeid').val(data.id); 
			$('.revalutionreserveaccountcodeglcode').val(data.glcode);
		}
  });
}
function assetaccountcode_initialize() {
	 var custom = new Bloodhound({
	    datumTokenizer: function(d) { return d.tokens; },
	    queryTokenizer: Bloodhound.tokenizers.whitespace,
		   remote: {
	            ...
	            filter: function (data) {
	                ...
	                return $.map(responseObj, function (ct) {
	                    return {
	                        ...
	                        glcode: ct.glcode,
	                        issubledger: ct.isSubLedger,
	                        assetaccountcodesearch: ct.glcode+' ~ '+ct.name
	                    };
	                });
	            }
	        }
  ...
  var dt=$('.assetaccountcode').typeahead({
  	hint : true,
		highlight : true,
		minLength : 1
		
	}, {		    
        displayKey: 'assetaccountcodesearch',
        source: custom.ttAdapter()
  }).on('typeahead:selected typeahead:autocompleted', function (event, data) {
	   ...
	   if(data.issubledger && originaldetailtypeid!='' && originaldetailkeyid=='')
	    {
		   bootbox.alert($.i18n.prop('msg.please.enter',subLedgerDisplayName),function() {
			...
			$(this).parents("tr:first").find('.creditDetailTypeName').val(detailTypeName);
			$(this).parents("tr:first").find('.creditDetailKeyName').val(detailKeyName);
			$('.assetaccountcodename').val(data.name);
			$('.assetaccountcodeid').val(data.id); 
			$('.assetaccountcodeglcode').val(data.glcode);
		}
  });
}
function accumulateddepriciationcode_initialize() {
	 var custom = new Bloodhound({
	    datumTokenizer: function(d) { return d.tokens; },
	    queryTokenizer: Bloodhound.tokenizers.whitespace,
		   remote: {
	            ...
	            filter: function (data) {
	                ...
	                return $.map(responseObj, function (ct) {
	                    return {
	                        ...
	                        glcode: ct.glcode,
	                        issubledger: ct.isSubLedger,
	                        accumulateddepriciationcodesearch: ct.glcode+' ~ '+ct.name
	                    };
	                });
	            }
	        }
  ...
  var dt=$('.accumulateddepriciationcode').typeahead({
  	hint : true,
		highlight : true,
		minLength : 1
		
	}, {		    
        displayKey: 'accumulateddepriciationcodesearch',
        source: custom.ttAdapter()
  }).on('typeahead:selected typeahead:autocompleted', function (event, data) {
	   ...
	   if(data.issubledger && originaldetailtypeid!='' && originaldetailkeyid=='')
	    {
		   bootbox.alert($.i18n.prop('msg.please.enter',subLedgerDisplayName),function() {
			...
			$(this).parents("tr:first").find('.creditDetailTypeName').val(detailTypeName);
			$(this).parents("tr:first").find('.creditDetailKeyName').val(detailKeyName);
			$('.accumulateddepriciationcodename').val(data.name);
			$('.accumulateddepriciationcodeid').val(data.id); 
			$('.accumulateddepriciationcodeglcode').val(data.glcode);
		}
  });
}
function depriciationexpenseaccount_initialize() {
	 var custom = new Bloodhound({
	    datumTokenizer: function(d) { return d.tokens; },
	    queryTokenizer: Bloodhound.tokenizers.whitespace,
		   remote: {
	            ...
	            filter: function (data) {
	                ...
	                return $.map(responseObj, function (ct) {
	                    return {
	                        ...
	                        glcode: ct.glcode,
	                        issubledger: ct.isSubLedger,
	                        depriciationexpenseaccountsearch: ct.glcode+' ~ '+ct.name
	                    };
	                });
	            }
	        }
  ...
  var dt=$('.depriciationexpenseaccount').typeahead({
  	hint : true,
		highlight : true,
		minLength : 1
		
	}, {		    
        displayKey: 'depriciationexpenseaccountsearch',
        source: custom.ttAdapter()
  }).on('typeahead:selected typeahead:autocompleted', function (event, data) {
	   ...
	   if(data.issubledger && originaldetailtypeid!='' && originaldetailkeyid=='')
	    {
		   bootbox.alert($.i18n.prop('msg.please.enter',subLedgerDisplayName),function() {
			...
			$(this).parents("tr:first").find('.creditDetailTypeName').val(detailTypeName);
			$(this).parents("tr:first").find('.creditDetailKeyName').val(detailKeyName);
			$('.depriciationexpenseaccountname').val(data.name);
			$('.depriciationexpenseaccountid').val(data.id); 
			$('.depriciationexpenseaccountglcode').val(data.glcode);
		}
  });
}
