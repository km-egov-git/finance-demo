...
<form:form role="form" action="updateBudgetSO"
	modelAttribute="budgetWrapper" id="approvebudgetsearchform"
			...
			<div class="col-md-12">
				...
				<th>Quarter-Four Percentage</th>
					...
					<!--  <tr>
					 ...
					 <tr>
					 <td>
					${details.execDeptName }
		<input type="hidden" name="budgetDetails[${item.index}].id" id="budgetDetails[${item.index}].id" value="${details.id }" >
					...
					${details.function.name }
					 ...
					 <td>${details.budgetGroup.name }</td>
					 <td>
					 <input type="text" name="budgetDetails[${item.index}].originalAmount" id="budgetDetails[${item.index}].originalAmount" data-idx="0" value="${details.originalAmount }" required="required" Class="form-control"  />
					 <form:errors path="" cssClass="error-msg" />
					 </td>
					 <td>${details.anticipatoryAmount }</td>
					 <td>
					 <input type="text" name="budgetDetails[${item.index}].planningPercent" id="budgetDetails[${item.index}].planningPercent" data-idx="0" value="${details.planningPercent }"  required="required" Class="form-control" />
					<form:errors path="" cssClass="error-msg" />
					 </td>
					 <td>
					 <input type="text" name="budgetDetails[${item.index}].quarterpercent" id="budgetDetails[${item.index}].quarterpercent" data-idx="0" value="${details.quarterpercent }"  required="required" Class="form-control" />
					 <form:errors path="" cssClass="error-msg" />
					 </td>
					 <td>
					 <input type="text" name="budgetDetails[${item.index}].quartertwopercent" id="budgetDetails[${item.index}].quartertwopercent" data-idx="0" value="${details.quartertwopercent }"  required="required" Class="form-control" />
					 <form:errors path="" cssClass="error-msg" />
					 </td>
					  <td>
					 <input type="text" name="budgetDetails[${item.index}].quarterthreepercent" id="budgetDetails[${item.index}].quarterthreepercent" data-idx="0" value="${details.quarterthreepercent }"  required="required" Class="form-control" />
					 <form:errors path="" cssClass="error-msg" />
					 </td>
					  <td>
					 <input type="text" name="budgetDetails[${item.index}].quarterfourpercent" id="budgetDetails[${item.index}].quarterfourpercent" data-idx="0" value="${details.quarterfourpercent }"  required="required" Class="form-control" />
					 <form:errors path="" cssClass="error-msg" />
					 </td>
					 </tr>
					 </c:forEach>
						...
						<div class="form-group">
							<div class="text-center">
								<button type='submit' class='btn btn-primary' id="btnsearch">
									<spring:message code='lbl.forward' />
								</button>
