...
<s:form theme="simple" name="searchReceiptForm" action="searchReceipt-searchDayBookReportNew.action">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <option value="">----Choose----</option>
    ...
    <option value="POS MOH B&D"> POS MOH B&D</option> 
    <option value="POS MOH Cattle"> POS MOH Cattle</option>
    <option value="POS MOH SLH">POS MOH SLH</option>
</select> </td>
...
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Cheque/DD No" style="width:12%;text-align:left" property="bank" />
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Cheque/DD Date" style="width:12%;text-align:left" property="bank" />
...
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Department" style="width:27%;text-align:left" property="department" />
